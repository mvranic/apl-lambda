...
##git clone https://github.com/mvranic/JSONServer.git output/opt/JSONServer 

# HttpCommand is needed only.½ 
...
docker -H:2375 run --rm apl-provided-lambda-v17.1.x cat /tmp/node-v${APL_VERSION}.zip > ./layer.zip
